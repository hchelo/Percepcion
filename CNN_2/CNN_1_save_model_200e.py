...
# Callbacks para ajustar el learning rate, guardar el mejor modelo y EarlyStopping
...
history = model.fit(
    ...
    callbacks=[lr_scheduler, checkpoint, early_stopping]  # Añadir EarlyStopping aquí
)
