    ...
    for file_name in os.listdir(folder_path):
        ...
        for result in results:
            ...
            if predicted_class != true_label:
                label = f"Pred: {class_labels[predicted_class]} ({confidence:.2f}), Real: {class_labels[true_label]}"
                ...
                # Mostrar imagen mal clasificada
                cv2.imshow(f"Mal clasificada: {file_name}", image)
