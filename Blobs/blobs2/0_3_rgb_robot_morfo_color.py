...
archivo_imagen = 'roboticolor.jpg'  # Actualiza esta línea con la ruta correcta del archivo de imagen
...
for y in range(height):
    for x in range(width):
        ...
        # verde    
            ...
            img[y, x] = (0, 255, 0) 
        # rojo    
        elif (r <= 255) and (r >= 234) and (g <= 185) and (g >= 76) and (b <= 223) and (b >= 151):
            img[y, x] = (0, 0, 255)     
        else:
