...
color_flecha = (0, 255, 255)   # amarillo (BGR), resalta sobre el video
mostrar_angulo = False         # True = escribe también el ángulo sobre la original
...
while cap.isOpened():
    ...
    pixeles = np.float64(frame).reshape((-1, 3))
